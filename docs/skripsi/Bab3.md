...
> Catatan: Berkas ini berisi naskah sub-bagian 3.1 Tahapan Penelitian beserta sub-bagian 3.3 hingga 3.9 sesuai revisi terbaru. Sub-bagian 3.2 Objek Penelitian yang telah disetujui sebelumnya tetap dipertahankan.
...
### 3.4.1 Identifikasi Akun Studi Kasus
...
### 3.4.2 Pengumpulan Data Unggahan Konten
...
#### 3.5.1.1 Identifikasi Permasalahan Pengguna
...
#### 3.5.1.2 Identifikasi Celah Penelitian
...
### 3.5.4 Analisis Kebutuhan Pengguna
...
### 3.6.1 Perancangan Arsitektur Sistem
...
### 3.6.2 Perancangan Proses Bisnis
...
### 3.6.4 Perancangan Struktur Navigasi
...
### 3.7.1 Penyiapan Lingkungan Pengembangan
...
### 3.7.2 Pengkodean Antarmuka Pengguna
...
### 3.7.3 Pengkodean Logika Aplikasi
...
### 3.7.4 Pengkodean Layanan Basis Data
...
### 3.7.5 Pengkodean Layanan Kecerdasan Buatan
...
### 3.8.1 Penyiapan Lingkungan Produksi
...
### 3.8.2 Penerapan Sistem ke Lingkungan Produksi
...
#### 3.9.1.1 Penyusunan Skenario Pengujian
...
#### 3.9.1.2 Pelaksanaan Pengujian Modul
...
### 3.9.2 Pengujian Penerimaan Pengguna
